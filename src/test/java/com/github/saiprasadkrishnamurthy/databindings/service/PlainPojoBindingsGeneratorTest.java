...
class PlainPojoBindingsGeneratorTest {
    ...
    private PlainPojoBindingsGenerator plainPojoBindingsGenerator;

    @BeforeEach
    void setUp() {
        plainPojoBindingsGenerator = new PlainPojoBindingsGenerator(dataElementsRepository);
    }

    @Test
    void generate() throws Exception {
        DataElement engineer = OBJECTMAPPER.readValue(IOUtils.toString(PlainPojoBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/engineer.json"), Charset.defaultCharset()), DataElement.class);
        ...
        plainPojoBindingsGenerator.generate(dataBindingsGenerationRequest);
        ...
        List<String> expectedFileLines = Arrays.asList(IOUtils.toString(PlainPojoBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("output/Engineer.java"), Charset.defaultCharset()).split("\n"));
