...
class DependencyGraphBindingsGeneratorTest {
    ...
    private DependencyGraphBindingsGenerator dependencyGraphBindingsGenerator;

    @BeforeEach
    void setUp() {
        dependencyGraphBindingsGenerator = new DependencyGraphBindingsGenerator(dataElementsRepository);
    }

    @Test
    void generate() throws Exception {
        DataElement person = OBJECTMAPPER.readValue(IOUtils.toString(DependencyGraphBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/person.json"), Charset.defaultCharset()), DataElement.class);
        DataElement address = OBJECTMAPPER.readValue(IOUtils.toString(DependencyGraphBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/address.json"), Charset.defaultCharset()), DataElement.class);
        DataElement employee = OBJECTMAPPER.readValue(IOUtils.toString(DependencyGraphBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/employee.json"), Charset.defaultCharset()), DataElement.class);
        DataElement engineer = OBJECTMAPPER.readValue(IOUtils.toString(DependencyGraphBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/engineer.json"), Charset.defaultCharset()), DataElement.class);
        DataElement engineerType = OBJECTMAPPER.readValue(IOUtils.toString(DependencyGraphBindingsGeneratorTest.class.getClassLoader().getResourceAsStream("input/engineerType.json"), Charset.defaultCharset()), DataElement.class);
